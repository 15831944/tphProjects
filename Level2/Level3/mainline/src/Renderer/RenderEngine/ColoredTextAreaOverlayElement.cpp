...
//
//////////////////////////////////////////////////////////////////////////
String ColoredTextAreaOverlayElementFactory::FACTORY_TYPE_NAME = "ColorTextArea";

const String& Ogre::ColoredTextAreaOverlayElementFactory::getTypeName() const
{
	return FACTORY_TYPE_NAME;
}


void Ogre::ColoredTextAreaOverlayElement::getWorldTransforms( Matrix4* xform ) const
{	
	__super::getWorldTransforms(xform);
	//xform[0] = Matrix4::getTrans(mTransf);
}

const String& Ogre::ColoredTextAreaOverlayElement::getTypeName( void ) const
{
	return ColoredTextAreaOverlayElementFactory::FACTORY_TYPE_NAME;
}

void Ogre::ColoredTextAreaOverlayElement::SetTransf( const Vector3& transf )
{
	mTransf = transf;
