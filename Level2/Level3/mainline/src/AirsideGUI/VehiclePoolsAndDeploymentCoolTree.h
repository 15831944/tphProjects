...
/////////////////////////////////////////////////////////////////////////////
// CVehiclePoolsAndDeploymentCoolTree window
...
class AIRSIDEGUI_API CVehiclePoolsAndDeploymentCoolTree : public CTreeCtrl
{
...
// Overrides
	...
	//{{AFX_VIRTUAL(CVehiclePoolsAndDeploymentCoolTree)
	protected:
...
public:
	...
	virtual ~CVehiclePoolsAndDeploymentCoolTree();
	BOOL DeleteItem( HTREEITEM hItem );
	int m_nWidth;
	void SetWidth(int nWidth){m_nWidth = nWidth;}
	// Generated message map functions
protected:
	//{{AFX_MSG(CVehiclePoolsAndDeploymentCoolTree)
