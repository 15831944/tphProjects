...
BEGIN_MESSAGE_MAP(CMuliSeltTreeCtrlEx, CTreeCtrl)
	//{{AFX_MSG_MAP(CMuliSeltTreeCtrlEx)
	ON_WM_LBUTTONDOWN()
	ON_WM_LBUTTONUP()
	ON_WM_MOUSEMOVE()
	ON_WM_KEYDOWN()
...
IMPLEMENT_DYNAMIC(CMuliSeltTreeCtrlEx, CTreeCtrl)

BOOL CMuliSeltTreeCtrlEx::Create(DWORD dwStyle, DWORD dwExStyle, const RECT& rect, CWnd* pParentWnd, UINT nID)
{
#if _MFC_VER < 0x0700
...
BOOL CMuliSeltTreeCtrlEx::Create(DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID)
{
...
/////////////////////////////////////////////////////////////////////////////
// CMuliSeltTreeCtrlEx message handlers
...
void CMuliSeltTreeCtrlEx::OnLButtonDown( UINT nFlags, CPoint point )
{
...
void CMuliSeltTreeCtrlEx::OnLButtonUp( UINT nFlags, CPoint point )
{
	if ( m_bSelectPending )
	{
...
void CMuliSeltTreeCtrlEx::OnMouseMove( UINT nFlags, CPoint point )
{
...
void CMuliSeltTreeCtrlEx::SelectMultiple( HTREEITEM hClickedItem, UINT nFlags, CPoint point )
{
...
void CMuliSeltTreeCtrlEx::OnKeyDown( UINT nChar, UINT nRepCnt, UINT nFlags ) 
{
	CWnd* pWnd = GetParent();
...
void CMuliSeltTreeCtrlEx::OnRButtonDown( UINT nFlags, CPoint point )
{
	UINT nHitFlags = 0;
	HTREEITEM hClickedItem = HitTest( point, &nHitFlags );
...
UINT CMuliSeltTreeCtrlEx::GetSelectedCount() const
{
...
HTREEITEM CMuliSeltTreeCtrlEx::GetNextItem(HTREEITEM hItem, UINT nCode)
{
...
HTREEITEM CMuliSeltTreeCtrlEx::GetFirstSelectedItem()
{
	for ( HTREEITEM hItem = GetRootItem(); hItem!=NULL; hItem = GetNextVisibleItem( hItem ) )
		if ( GetItemState( hItem, TVIS_SELECTED ) & TVIS_SELECTED )
			return hItem;
...
HTREEITEM CMuliSeltTreeCtrlEx::GetNextSelectedItem( HTREEITEM hItem )
{
...
HTREEITEM CMuliSeltTreeCtrlEx::GetPrevSelectedItem( HTREEITEM hItem )
{
...
BOOL CMuliSeltTreeCtrlEx::SelectItemEx(HTREEITEM hItem, BOOL bSelect/*=TRUE*/)
{
...
BOOL CMuliSeltTreeCtrlEx::SelectItems( HTREEITEM hFromItem, HTREEITEM hToItem )
{
...
void CMuliSeltTreeCtrlEx::ClearSelection(BOOL bMultiOnly/*=FALSE*/)
{
//	if ( !bMultiOnly )
//		SelectItem( NULL );
...
BOOL CMuliSeltTreeCtrlEx::OnItemexpanding(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
BOOL CMuliSeltTreeCtrlEx::OnSelchanged(NMHDR* pNMHDR, LRESULT* pResult)
{
...
BOOL CMuliSeltTreeCtrlEx::OnSetfocus(NMHDR* pNMHDR, LRESULT* pResult) 
{
	Invalidate();
	*pResult = 0;
	return FALSE;
...
BOOL CMuliSeltTreeCtrlEx::OnKillfocus(NMHDR* pNMHDR, LRESULT* pResult) 
{
	Invalidate();
	*pResult = 0;
	return FALSE;
...
void CMuliSeltTreeCtrlEx::OnLButtonDblClk(UINT nFlags, CPoint point)
{
...
void CMuliSeltTreeCtrlEx::OnTimer(UINT nIDEvent)
{
...
HTREEITEM CMuliSeltTreeCtrlEx::ItemFromData(DWORD dwData, HTREEITEM hStartAtItem/*=NULL*/) const
{
