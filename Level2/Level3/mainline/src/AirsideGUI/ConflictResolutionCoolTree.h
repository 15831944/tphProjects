...
/////////////////////////////////////////////////////////////////////////////
// CConflictResolutionCoolTree window
...
class AIRSIDEGUI_API CConflictResolutionCoolTree : public CTreeCtrl
{
...
// Overrides
	...
	//{{AFX_VIRTUAL(CConflictResolutionCoolTree)
	protected:
...
public:
	...
	virtual ~CConflictResolutionCoolTree();
	BOOL DeleteItem( HTREEITEM hItem );
	int m_nWidth;
	void SetWidth(int nWidth){m_nWidth = nWidth;}
	// Generated message map functions
protected:
	//{{AFX_MSG(CConflictResolutionCoolTree)
