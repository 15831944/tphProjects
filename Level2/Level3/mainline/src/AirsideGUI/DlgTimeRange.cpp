...
CDlgTimeRange::CDlgTimeRange(const ElapsedTime& startTime, const ElapsedTime& endTime, CWnd* pParent /*=NULL*/)
...
ElapsedTime CDlgTimeRange::GetStartTime() const
{
...
ElapsedTime CDlgTimeRange::GetEndTime() const
{
