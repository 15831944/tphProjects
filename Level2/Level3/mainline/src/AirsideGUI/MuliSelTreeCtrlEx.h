...
/////////////////////////////////////////////////////////////////////////////
// CMuliSeltTreeCtrlEx window

class CMuliSeltTreeCtrlEx : public CTreeCtrl
{
	DECLARE_DYNAMIC(CMuliSeltTreeCtrlEx)

// Construction
public:
	CMuliSeltTreeCtrlEx() : m_bSelectPending(FALSE), m_hClickedItem(NULL), m_hFirstSelectedItem(NULL), m_bSelectionComplete(TRUE), m_bEditLabelPending(FALSE) {}
...
// Overrides
	...
	//{{AFX_VIRTUAL(CMuliSeltTreeCtrlEx)
	//}}AFX_VIRTUAL

// Implementation
public:
	virtual ~CMuliSeltTreeCtrlEx() {}

	// Generated message map functions
protected:
	//{{AFX_MSG(CMuliSeltTreeCtrlEx)
