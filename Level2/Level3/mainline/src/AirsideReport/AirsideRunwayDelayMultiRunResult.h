...
private:
    ...
    void SetSummaryTotalDelay3DChartString(C2DChartData& c2dGraphData, CParameters *pParameter,TimeInterval* pTimeInterval);
    void SetSummaryLandingRoll3DChartString(C2DChartData& c2dGraphData,CParameters *pParameter, TimeInterval* pTimeInterval);
    void SetSummaryExisting3DChartString(C2DChartData& c2dGraphData, CParameters *pParameter,TimeInterval* pTimeInterval);
    void SetSummaryInTakeoffQ3DChartString(C2DChartData& c2dGraphData,CParameters *pParameter, TimeInterval* pTimeInterval);
    void SetSummaryHoldShortLine3DChartString(C2DChartData& c2dGraphData,CParameters *pParameter, TimeInterval* pTimeInterval);
    void SetSummaryInPosition3DChartString(C2DChartData& c2dGraphData, CParameters *pParameter,TimeInterval* pTimeInterval);
	...
	void CopyRunwayDelaySummaryData(mapSummaryDataOfInterval& summaryInterval,AirsideFlightRunwayDelaySummaryData* pSummary);
private:
