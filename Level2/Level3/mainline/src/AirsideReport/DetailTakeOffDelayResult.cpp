...
CDetailTakeOffDelayResult::CDetailTakeOffDelayResult(void)
{
}
...
int CDetailTakeOffDelayResult::GetFlightCountInIntervalTime(FlightConstraint& fltConstraint, ElapsedTime& estMinDelayTime, ElapsedTime& estMaxDelayTime, 
...
void CDetailTakeOffDelayResult::Draw3DChart(CARC3DChart& chartWnd, CParameters *pParameter)
{
	CString strLabel = _T("");
