...
void CAirsideAircraftMultiRunTakeoffProcessResult::SetDetailTakeoffQDelay3DChartString( C2DChartData& c2dGraphData, CParameters *pParameter )
{
	...
	strFooter.Format(_T("Multiple Run Report Take off Q delay(Detailed) %s,%s "),GetMultipleRunReportString(),pParameter->GetParameterString());
...
void CAirsideAircraftMultiRunTakeoffProcessResult::SetDetailTakeoffDelay3DChartString( C2DChartData& c2dGraphData, CParameters *pParameter )
{
	...
	//set footer
	CString strFooter(_T(""));
	strFooter.Format(_T("Multiple Run Report Take off delay(Detailed) %s,%s "),GetMultipleRunReportString(),pParameter->GetParameterString());
	c2dGraphData.m_strFooter = strFooter;
}
...
void CAirsideAircraftMultiRunTakeoffProcessResult::SetDetailTimeToPosition3DChartString( C2DChartData& c2dGraphData, CParameters *pParameter )
{
	...
	//set footer
	CString strFooter(_T(""));
	strFooter.Format(_T("Multiple Run Report Time to position(Detailed) %s,%s "),GetMultipleRunReportString(),pParameter->GetParameterString());
	c2dGraphData.m_strFooter = strFooter;
}
...
{
    c2dGraphData.m_strChartTitle = _T(" Take off Q time ");
    c2dGraphData.m_strYtitle = _T("Time(mins)");
    c2dGraphData.m_strXtitle = _T("Runs");	

    //set footer
    CString strFooter(_T(""));
    strFooter.Format(_T("Multiple Run Report Summary Take off Q time  %s,%s "),GetMultipleRunReportString(), pParameter->GetParameterString());
    c2dGraphData.m_strFooter = strFooter;
}
...
{
    c2dGraphData.m_strChartTitle = _T(" Time at Hold Short Line ");
    c2dGraphData.m_strYtitle = _T("Time(mins)");
    c2dGraphData.m_strXtitle = _T("Runs");	

    //set footer
    CString strFooter(_T(""));
    strFooter.Format(_T("Multiple Run Report Summary Time at Hold Short Line Report %s,%s "), GetMultipleRunReportString(),pParameter->GetParameterString());
    c2dGraphData.m_strFooter = strFooter;
}
...
{
    c2dGraphData.m_strChartTitle = _T(" Taxi to Position ");
    c2dGraphData.m_strYtitle = _T("Time(mins)");
    c2dGraphData.m_strXtitle = _T("Runs");	

    //set footer
    CString strFooter(_T(""));
    strFooter.Format(_T("Multiple Run Report Summary Taxi to Position %s,%s "), GetMultipleRunReportString(),pParameter->GetParameterString());
    c2dGraphData.m_strFooter = strFooter;
}
...
{
    c2dGraphData.m_strChartTitle = _T(" Time in Position ");
    c2dGraphData.m_strYtitle = _T("Time(mins)");
    c2dGraphData.m_strXtitle = _T("Runs");	

    //set footer
    CString strFooter(_T(""));
    strFooter.Format(_T("Multiple Run Report Summary Time in Position %s,%s "), GetMultipleRunReportString(),pParameter->GetParameterString());
    c2dGraphData.m_strFooter = strFooter;
}
