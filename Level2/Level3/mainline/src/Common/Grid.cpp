...
TiXmlElement * CGrid::serializeTo( TiXmlElement * tiElm, int nVersion) const
{
...
void CGrid::serializeFrom( const TiXmlElement* pElm , int nVersion)
{
	int tmpInt;
	//double tmpFloat;
...
void CGrid::InitDefault( double sizex /*= 1000*/,double sizey/*=1000*/,double lineevery/*=500.0*/ )
{
	bVisibility = TRUE;
