...
// all constants that define string lengths should have space for the
// NULL character terminator
#define MAX_PAX_TYPES	     16  // 4
...
//to test function's performace 
/*
#ifndef CODE_PERFOMANCE_DEBUGE_FLAG
	#define  CODE_PERFOMANCE_DEBUGE_FLAG 		
#endif
*/
...
// Input files
	...
	ProbabilityDistributionFile,// no: 18
	GlobalDBListFile,
	PassengerBulkFile,
	FlowSyncFile,
    RosterRulesFile ,
...
// CSV echo files
    PaxLogEchoFile,// = LogBackupFile + 5,//no: 39
    FlightLogEchoFile,
    ProcLogEchoFile,
    BagLogEchoFile,
    StringDictEchoFile,// no:43

// Report Specifications Files
    DistanceSpecFile,//= StringDictEchoFile + 5, // no:48
    DurationSpecFile,
    PaxLogSpecFile,
    ProcLogSpecFile,
    FlightLogSpecFile,
...
// Report Output Files
	...
	BagDistReportFile,
	BagDeliveryTimeReportFile,// no:96
