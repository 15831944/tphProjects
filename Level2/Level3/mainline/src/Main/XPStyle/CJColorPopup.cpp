...
{
//	m_crColors[0].crColor=RGB(0x00, 0x00, 0x00);
...
CCJColorPopup::CCJColorPopup(CPoint p, COLORREF crColor, CWnd* pParentWnd,
                           ...
                           LPCTSTR szCustomText  /* = NULL */,BOOL bToolBarPopup)
{
 m_crColors[0].crColor= RGB(0x00, 0x00, 0x00);
 m_crColors[1].crColor= RGB(0xA5, 0x2A, 0x00);
 m_crColors[2].crColor= RGB(0x00, 0x40, 0x40); 
 m_crColors[3].crColor= RGB(0x00, 0x55, 0x00); 
 m_crColors[4].crColor= RGB(0x00, 0x00, 0x5E); 
 m_crColors[5].crColor= RGB(0x00, 0x00, 0x8B); 
 m_crColors[6].crColor= RGB(0x4B, 0x00, 0x82); 
 m_crColors[7].crColor= RGB(0x28, 0x28, 0x28); 

 m_crColors[8].crColor= RGB(0x8B, 0x00, 0x00); 
 m_crColors[9].crColor= RGB(0xFF, 0x68, 0x20); 
 m_crColors[10].crColor= RGB(0x8B, 0x8B, 0x00);
 m_crColors[11].crColor= RGB(0x00, 0x93, 0x00); 
 m_crColors[12].crColor= RGB(0x38, 0x8E, 0x8E); 
 m_crColors[13].crColor= RGB(0x00, 0x00, 0xFF); 
 m_crColors[14].crColor= RGB(0x7B, 0x7B, 0xC0);
 m_crColors[15].crColor= RGB(0x66, 0x66, 0x66); 

 m_crColors[16].crColor= RGB(0xFF, 0x00, 0x00); 
 m_crColors[17].crColor= RGB(0xFF, 0xAD, 0x5B);
 m_crColors[18].crColor= RGB(0x32, 0xCD, 0x32);
 m_crColors[19].crColor= RGB(0x3C, 0xB3, 0x71);
 m_crColors[20].crColor= RGB(0x7F, 0xFF, 0xD4); 
 m_crColors[21].crColor= RGB(0x7D, 0x9E, 0xC0);
 m_crColors[22].crColor= RGB(0x80, 0x00, 0x80); 
 m_crColors[23].crColor= RGB(0x7F, 0x7F, 0x7F); 

 m_crColors[24].crColor= RGB(0xFF, 0xC0, 0xCB); 
 m_crColors[25].crColor= RGB(0xFF, 0xD7, 0x00); 
 m_crColors[26].crColor= RGB(0xFF, 0xFF, 0x00);  
 m_crColors[27].crColor= RGB(0x00, 0xFF, 0x00); 
 m_crColors[28].crColor= RGB(0x40, 0xE0, 0xD0);
 m_crColors[29].crColor= RGB(0xC0, 0xFF, 0xFF); 
 m_crColors[30].crColor= RGB(0x48, 0x00, 0x48); 
 m_crColors[31].crColor= RGB(0xC0, 0xC0, 0xC0);

 m_crColors[32].crColor= RGB(0xFF, 0xE4, 0xE1); 
 m_crColors[33].crColor= RGB(0xD2, 0xB4, 0x8C);
 m_crColors[34].crColor= RGB(0xFF, 0xFF, 0xE0);  
 m_crColors[35].crColor= RGB(0x98, 0xFB, 0x98); 
 m_crColors[36].crColor= RGB(0xAF, 0xEE, 0xEE); 
 m_crColors[37].crColor= RGB(0x68, 0x83, 0x8B); 
 m_crColors[38].crColor= RGB(0xE6, 0xE6, 0xFA); 
 m_crColors[39].crColor= RGB(0xFF, 0xFF, 0xFF);  

 //m_crColors[0].szName=::LoadStrFromID2(IDS_COLOR_BLACK);

m_crColors[0].szName="Black" ;
m_crColors[1].szName="Brown"             ;
m_crColors[2].szName="Darkogreen"  ;
m_crColors[3].szName="Darkgreen"        ;
m_crColors[4].szName="Darkteal"         ;
m_crColors[5].szName="Darkblue"         ;
m_crColors[6].szName="Indigo"          ;
m_crColors[7].szName="Darkgrey"         ;

m_crColors[8].szName="Darkred"          ;
m_crColors[9].szName="Orange"            ;
m_crColors[10].szName="Darkyellow"       ;
m_crColors[11].szName="GReen"             ;
m_crColors[12].szName="TEal"              ;
m_crColors[13].szName="BLue"              ;
m_crColors[14].szName="BLuegrey"         ;
m_crColors[15].szName="GRey40"         ;

m_crColors[16].szName="Red"               ;
m_crColors[17].szName="Lightorange"      ;
m_crColors[18].szName="Lime"              ; 
m_crColors[19].szName="Seagreen"         ;
m_crColors[20].szName="Aqua"              ;
m_crColors[21].szName="Lightblue"        ;
m_crColors[22].szName="Violet"            ;
m_crColors[23].szName="Grey50"         ;

m_crColors[24].szName="Pink"              ;
m_crColors[25].szName="Gold" ;
m_crColors[26].szName="Yellow"            ;    
m_crColors[27].szName="Brightgreen"      ;
m_crColors[28].szName="Turquoise"         ;
m_crColors[29].szName="Skyblue"           ;
m_crColors[30].szName="Plum"              ;
m_crColors[31].szName="Lightgrey"        ;

m_crColors[32].szName="Rose"              ;
m_crColors[33].szName="Tan"               ;
m_crColors[34].szName="Lightyellow"      ;
m_crColors[35].szName="Lightgreen "       ;
m_crColors[36].szName="Paleturquoise"    ;
m_crColors[37].szName="Paleblue"         ;
m_crColors[38].szName="Lavender"          ;
m_crColors[39].szName="White"             ;
...
void CCJColorPopup::EndSelection(int nMessage)
{
	...
	{
		m_crColor=GetSysColor(COLOR_BTNFACE);
	}
