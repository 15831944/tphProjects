...
// LandsideReportListView form view
...
class LandsideReportListView : public CFormView
{
	DECLARE_DYNCREATE(LandsideReportListView)

protected:
	LandsideReportListView();           // protected constructor used by dynamic creation
	virtual ~LandsideReportListView();

public:
	enum { IDD = IDD_DIALOG_REPORT_LISTGRID_LANDSIDE };
#ifdef _DEBUG
