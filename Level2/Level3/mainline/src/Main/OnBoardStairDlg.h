...
class COnBoardStairDlg :
	public COnBoardObjectBaseDlg,public CUnitPiece
{
public:
	DECLARE_DYNAMIC(COnBoardStairDlg)
public:
	COnBoardStairDlg(COnBoardStair *pStair,CAircaftLayOut *pLayout, int nProjID, CWnd* pParent = NULL);
	~COnBoardStairDlg(void);
