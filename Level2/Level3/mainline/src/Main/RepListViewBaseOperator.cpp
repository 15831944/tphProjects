...
CRepListViewBaseOperator::CRepListViewBaseOperator(CListCtrl *pListCtrl,CARCReportManager *pReportManager,CFormView *pListView)
{
...
CListCtrl& CRepListViewBaseOperator::GetListCtrl()
{
	return *m_pListCtrl;
}
