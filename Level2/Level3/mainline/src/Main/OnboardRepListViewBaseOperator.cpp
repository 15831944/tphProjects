...
COnboardRepListViewBaseOperator::COnboardRepListViewBaseOperator( CListCtrl *pListCtrl, CARCReportManager* pARCReportManager,OnboardReportListView *pListView )
