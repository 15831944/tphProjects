...
LRESULT CMainFrame::OnSendExportZipToARC(WPARAM wParam,LPARAM lParam)
{
	...
	CFileDialog dlgFile( FALSE, ".zip",pDoc->m_ProjInfo.name+(bNotForceDB?"_project Not Force DB":"_project"),OFN_OVERWRITEPROMPT|OFN_HIDEREADONLY,"zip Files (*.zip)|*.zip||", NULL, 0, FALSE  );
