...
,m_eOpenType(CRosterRulesBySchedTime::Before)
,m_eCloseType(CRosterRulesBySchedTime::Before)
{
...
ElapsedTime CRosterRulesBySchedTime::GetRosterOpenTiem( Flight* pflight, char mode )
{
	...
	if (m_eOpenType == CRosterRulesBySchedTime::Before)
...
ElapsedTime CRosterRulesBySchedTime::GetRosterCloseTime( Flight* pflight, char mode )
{
	...
	if (m_eCloseType == CRosterRulesBySchedTime::Before)
