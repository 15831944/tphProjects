// ReportParaWithArea.h: interface for the CReportParaWithArea class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_REPORTPARAWITHAREA_H__89EF5B59_B217_4960_A1BE_5D49B6F7DA25__INCLUDED_)
#define AFX_REPORTPARAWITHAREA_H__89EF5B59_B217_4960_A1BE_5D49B6F7DA25__INCLUDED_
...
class CReportParaWithArea : public CReportParameter  
{
	std::vector<CString> m_vAreas;
public:
	CReportParaWithArea(CReportParameter* _pDecorator);
	virtual ~CReportParaWithArea();
private:
	CReportParaWithArea(const CReportParaWithArea&); //disallow copy constructor
	CReportParaWithArea& operator=(const CReportParaWithArea&); //disallow assignment
...
#endif // !defined(AFX_REPORTPARAWITHAREA_H__89EF5B59_B217_4960_A1BE_5D49B6F7DA25__INCLUDED_)
