...
{
    int x = ((CTermPlanApp*)AfxGetApp())->GetProfileInt(szSection, szEntryX, -1);
    int y = ((CTermPlanApp*)AfxGetApp())->GetProfileInt(szSection, szEntryY, -1);
...
{   
    ...
    ((CTermPlanApp*)AfxGetApp())->WriteProfileInt(szSection, szEntryX, rect.left);
    ((CTermPlanApp*)AfxGetApp())->WriteProfileInt(szSection, szEntryY, rect.top);
}