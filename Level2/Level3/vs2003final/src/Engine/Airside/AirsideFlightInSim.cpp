...
public:	
	...
	static Log(AirsideFlightInSim* pFlight, const Clearance& clearance)
	{
	...
	static LogEvent(AirsideFlightInSim* pFlight, const ElapsedTime& eventTime)
	{
		PLACE_METHOD_TRACK_STRING();
	...
	static LogLog(AirsideFlightInSim* pFlight, const AirsideFlightEventStruct& newEvent)
	{		
	...
	static InitLog(AirsideFlightInSim* pFlight)
	{
		char fltstr[255];
