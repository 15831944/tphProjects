...
{
public:	
	static Log(AirsideVehicleInSim* pVehicle, const Clearance& clearance)
	{
		//log to flight file
	...
	static InitLog(AirsideVehicleInSim* pVehicle)
	{
		CString debugfileName;
		debugfileName.Format( "C:\\VehicleDebug\\%d-%d.txt",pVehicle->GetVehicleTypeID(),pVehicle->GetID() );
		std::ofstream outfile;
	...
	static Log(AirsideVehicleInSim* pVehicle,const CPoint2008& pos , const ElapsedTime& time)
	{
		CString debugfileName;
		debugfileName.Format( "C:\\VehicleDebug\\%d-%d.txt",pVehicle->GetVehicleTypeID(),pVehicle->GetID() );
		std::ofstream outfile;
