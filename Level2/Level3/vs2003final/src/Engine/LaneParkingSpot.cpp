...
void LaneParkingSpotsGroup::addLane( LandsideLaneInSim* pLane, DistanceUnit distF, DistanceUnit distT,DistanceUnit spotlength,LandsideResourceInSim* pParent )
{
