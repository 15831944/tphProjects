// ReportParaOfProcs.h: interface for the CReportParaOfProcs class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_REPORTPARAOFPROCS_H__F53D94BB_DE2B_4AA1_81A3_C0266769368E__INCLUDED_)
#define AFX_REPORTPARAOFPROCS_H__F53D94BB_DE2B_4AA1_81A3_C0266769368E__INCLUDED_
...
class CReportParaOfProcs : public CReportParameter  
{
	std::vector<ProcessorID> m_vProcGroups;
public:
	CReportParaOfProcs(CReportParameter* _pDecorator);
	virtual ~CReportParaOfProcs();

private:
	CReportParaOfProcs(const CReportParaOfProcs&); //disallow copy constructor
	CReportParaOfProcs& operator=(const CReportParaOfProcs&); //disallow assignment
...
#endif // !defined(AFX_REPORTPARAOFPROCS_H__F53D94BB_DE2B_4AA1_81A3_C0266769368E__INCLUDED_)
