...
{
	CFileDialog dlgFile( FALSE, ".csv",NULL ,OFN_OVERWRITEPROMPT|OFN_HIDEREADONLY,"Floor (*.csv)|*.csv||" );
	CString sFileName;
...
void CAirsideMSView::OnFloorPictureLoad()
{
	...
	CFileDialog dlgFile( TRUE,NULL,NULL,OFN_HIDEREADONLY | OFN_OVERWRITEPROMPT,"Floor (*.csv)|*.csv||" );
