...
#include "../inputs/AirsideNodeList.h"
//#include "./DlgAirRouteDisplayProperties.h"
...
//	delete m_pDlgMovie;
	...
	//if(m_pLandsideView)delete m_pLandsideView;
...
{	
	...
	{		
		...
		if(distToCam>40000){
			...
			{
				if(dlIndex>=0 && dlIndex < (int) GetParentFrame()->PaxShapeDLIDs().size() )
