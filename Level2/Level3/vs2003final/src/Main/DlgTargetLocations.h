...
class CDlgTargetLocations : public CXTResizeDialog
{
	DECLARE_DYNAMIC(CDlgTargetLocations)

public:
	CDlgTargetLocations(InputTerminal * pInterm,int nProjID,CWnd* pParent = NULL);   // standard constructor
	virtual ~CDlgTargetLocations();

// Dialog Data
	enum { IDD = IDD_DIALOG_TARGETLOCATIONS };
...
private:
	...
	CTargetLocationsList m_targetLocationList;
