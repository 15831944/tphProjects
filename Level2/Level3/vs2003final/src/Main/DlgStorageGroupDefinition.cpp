// DlgStorageGroupDefiniton.cpp : implementation file
//

#include "stdafx.h"
#include "TermPlan.h"
#include "DlgStorageGroupDefinition.h"
...
IMPLEMENT_DYNAMIC(CDlgStorageGroupDefinition, CDialog)
CDlgStorageGroupDefinition::CDlgStorageGroupDefinition(CStorageGroup* pseatGroup ,CAircraftPlacements* placements,CWnd* pParent /*=NULL*/)
	: CDialog(CDlgStorageGroupDefinition::IDD, pParent)
{
...
CDlgStorageGroupDefinition::~CDlgStorageGroupDefinition()
{
}

void CDlgStorageGroupDefinition::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDlgStorageGroupDefinition, CDialog)
...
// CDlgStorageGroupDefiniton message handlers

#include <common/ARCStringConvert.h>
void CDlgStorageGroupDefinition::OnBnClickedOk()
{
...
void CDlgStorageGroupDefinition::HideDialog(CWnd* parentWnd)
{
	ShowWindow(SW_HIDE);
...
void CDlgStorageGroupDefinition::ShowDialog(CWnd* parentWnd)
{
	while (!parentWnd->IsKindOf(RUNTIME_CLASS(CMDIFrameWnd)) )
	{
...
void CDlgStorageGroupDefinition::OnBnClickedButtonDrawline()
{
	// TODO: Add your control notification handler code here
	ASSERT(m_pParentWnd);
...
void CDlgStorageGroupDefinition::OnBnClickedCancel()
{
	// TODO: Add your control notification handler code here
	//restore old data
...
bool CDlgStorageGroupDefinition::UpdateDataModify()
{
...
LRESULT CDlgStorageGroupDefinition::OnTempFallbackFinished(WPARAM wParam, LPARAM lParam)
{
	ShowWindow(SW_SHOW);	
	EnableWindow();
...
int CDlgStorageGroupDefinition::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
BOOL CDlgStorageGroupDefinition::OnInitDialog()
{
...
void CDlgStorageGroupDefinition::OnBnClickedRadioNumrow()
{
	// TODO: Add your control notification handler code here
	//UpdateData(TRUE);		
...
void CDlgStorageGroupDefinition::OnBnClickedRadioFitrow()
{
	// TODO: Add your control notification handler code here
