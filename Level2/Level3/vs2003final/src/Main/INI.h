...
{
public:
	void getSectionData(CString strSection,CStringList* pHistoryList);
	static int DispartStrToSomeInt(CString& str,int* pInt);
	CString GetDataRight(CString str);
	CString GetDataLeft(CString str);
