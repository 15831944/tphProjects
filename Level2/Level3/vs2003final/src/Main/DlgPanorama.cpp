...
void CDlgPanorama::OnEnChangeEditInclination()
{
	...
	if( m_dataList.GetSelectItem() )
	{
		...
		if( dInc > PanoramaViewData::MaxInclination || dInc < PanoramaViewData::MinInclination )
		{
			CString strWarning;
			strWarning.Format("The Inclination should between %d and %d ", (int)PanoramaViewData::MinInclination, (int) PanoramaViewData::MaxInclination );
