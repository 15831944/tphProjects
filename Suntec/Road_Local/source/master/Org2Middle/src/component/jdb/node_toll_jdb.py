...
class comp_node_toll_jdb(component.component_base.comp_base):
    '''
    classdocs
    '''
    ...
    def __init__(self):
        ...
        Constructor
        '''
        component.component_base.comp_base.__init__(self, 'Toll_Node')
    ...
    def _Do(self):
        ...
        toll_path = common.common_func.GetPath('toll')
