...
class comp_tile_jdb(component.component_base.comp_base):
    '''
    classdocs
    '''
    ...
    def __MakeTileNode(self):
        ...
        self.CreateIndex2('road_node_4326_objectid_idx')
    ...
    def __MakeTileLink(self):
        ...
        self.CreateIndex2('road_link_4326_objectid_idx')
        self.CreateIndex2('road_link_4326_from_node_id_idx')
        self.CreateIndex2('road_link_4326_to_node_id_idx')
    ...
    def __CreateCommonFunction(self):
        ...
        if self.CreateFunction2('mid_getSplitLinkID') == -1:
            return -1
        
        if self.CreateFunction2('mid_getSplitLinkIDArray') == -1:
            return -1
