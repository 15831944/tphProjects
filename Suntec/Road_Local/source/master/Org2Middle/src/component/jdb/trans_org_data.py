...
## 方面名称格式转换类
####################################################################################
class comp_trans_dirguide_jdb(component.component_base.comp_base):
    ...
    def __init__(self):
        ...
        Constructor
        '''
        component.component_base.comp_base.__init__(self, 'Trans_DirGuide')
...
## Highway Node格式转换
####################################################################################
class comp_trans_highway_node_jdb(component.component_base.comp_base):
    '''Highway Node格式转换。
    '''
    def __init__(self):
        '''
        Constructor
        '''
        component.component_base.comp_base.__init__(self, 'Trans_HighwayNode')
