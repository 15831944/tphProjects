...
class comp_shield_jdb(component.component_base.comp_base):
    '''
    shield
    '''
    ...
    def _DoCreateFunction(self):
        ...
        if self.CreateFunction2('rdb_cnv_function_class') == -1:
            return -1
        return 0
    ...
    def __MakeLinkShield(self):
        ...
        sqlcmd = """
                ...
                SELECT c.tile_link_id, 
                       name_id, 
                       rdb_cnv_function_class(naviclass_c, widearea_f) as shield_prior, 
                       1 as seqnm
                  FROM (
                        SELECT objectid, roadclass_c, naviclass_c, widearea_f, road_no, split_seq_num
                         FROM temp_road_link
                         where road_no > 0
                  ) as a
