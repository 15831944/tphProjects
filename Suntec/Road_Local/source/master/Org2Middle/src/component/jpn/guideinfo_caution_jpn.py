...
class comp_guideinfo_caution_jpn(component.component_base.comp_base):
    ...
    def _DoCreateTable(self):
        ...
        sqlcmd = 'Alter table temp_boundary drop CONSTRAINT enforce_geotype_the_geom;'
        ...
        sqlcmd = 'Alter table temp_inode drop CONSTRAINT enforce_geotype_the_geom;'
        self.pg.execute2(sqlcmd)
        self.pg.commit2()
    ...
    def _DoBoundary(self):
        ...
        sqlcmd = """
            INSERT INTO temp_hlink(link_id, s_node, e_node, one_way_code, the_geom)
        ...
        sqlcmd = """
            INSERT INTO temp_inode(link_id, s_node, e_node, one_way_code, the_geom)
        ...
        sqlcmd = """
            INSERT INTO temp_bnode(link_id, s_node, e_node, one_way_code, bnode, 
                                    link_id2, s_node2, e_node2, one_way_code2, the_geom)
                SELECT t1.link_id, t1.s_node, t1.e_node, t1.one_way_code, t1.bnode, 
                        t2.link_id, t2.s_node, t2.e_node, t2.one_way_code, t1.the_geom
                    FROM 
                    (
        ...
        sqlcmd = """
            INSERT INTO temp_guideinfo_boundary(inlinkid, nodeid, outlinkid, innode, outnode, out_adcd)
                ...
                (
                    ...
                    SELECT 
                        bnode,
                        mid_get_inout_link(link_id, s_node, e_node, one_way_code, 
