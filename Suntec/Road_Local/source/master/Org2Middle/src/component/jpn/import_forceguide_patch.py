...
class comp_import_forceguide_patch_jpn(component.component_base.comp_base):

    def __init__(self):

        component.component_base.comp_base.__init__(self, 'force_guide_patch')
    ...
    def __deal_with_forceguide_update(self):
        # import data
        forceguide_patch_update_full_path = common.common_func.GetPath('forceguide_update')
    ...
    def __deal_with_forceguide_append(self):
        ...
        forceguide_patch_append_full_path = common.common_func.GetPath('forceguide_append')
    ...
    def __deal_with_forceguide_friendly_append(self):
        # import forceguide_patch data into database
        forceguide_friendly_patch_append_full_path = common.common_func.GetPath('forceguide_friendly_append')
    ...
    def _Do(self):
        ...
        forceguide_patch_run_status = common.common_func.GetPath('forceguide_patch_open')
