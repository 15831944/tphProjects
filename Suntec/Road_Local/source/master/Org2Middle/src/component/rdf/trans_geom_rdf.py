...
class comp_trans_geom_rdf(component.component_base.comp_base):
    def __init__(self):
        '''
        Constructor
        '''
        component.component_base.comp_base.__init__(self, 'Trans_geom')
    ...
    def __NeedTranslate(self, src_table_name, dest_table_name, src_geom_col = 'the_geom'):
        ...
        row = self.pg.fetchone2()
        if row[0] == 0:
            self.CreateTable2(dest_table_name)
            return False
