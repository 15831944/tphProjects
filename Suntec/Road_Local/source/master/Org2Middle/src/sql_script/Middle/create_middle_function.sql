	...
	for rec in 
      ...
      (
          ...
          (
              ...
              join link_tbl_bak_for_linktype_test_bak as c
...
CREATE OR REPLACE FUNCTION mid_jct_linktype_modify(node bigint, path bigint[], node_s bigint, node_e bigint, dir integer)
	RETURNS integer
	LANGUAGE plpgsql volatile
AS $$
DECLARE
