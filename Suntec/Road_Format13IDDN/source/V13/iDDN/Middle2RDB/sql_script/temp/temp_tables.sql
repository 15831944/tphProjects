...
(
	select 	distinct
			b.link_id, b.region_tile_id, b.start_node_id, b.end_node_id, b.one_way, 
...
--			, j.ops_lane_number, j.ops_width, j.neg_lane_number, j.neg_width
	...
	left join rdb_link_add_info as h
...
(
	select	proxy_link_id, start_node_id, end_node_id, one_way, link_array, linkdir_array, fazm_path, tazm_path, 
			...
			pos_cond_speed, neg_cond_speed, link_type, link_length, the_geom
	from
	(
	    select	proxy_link_id, start_node_id, end_node_id, one_way, link_array, linkdir_array, fazm_path, tazm_path, 
	    ...
	    (
	        ...
	        (
	        	select	proxy_link_id, start_node_id, end_node_id, one_way, link_array, linkdir_array, fazm_path, tazm_path, link_num, merge_index, 
	        			...
	        			link_type, link_length, the_geom
	        	from
	        	(
...
as
(
	select	link_id, region_tile_id, start_node_id, end_node_id, road_type, pdm_flag, path_extra_info, one_way, function_code, link_length, link_type,
			road_name, toll, regulation_flag, fazm_path, tazm_path, struct_code, shortcut_code, etc_lane_flag, disobey_flag, 
			ops_lane_number, ops_width, neg_lane_number, neg_width, pos_cond_speed, neg_cond_speed, the_geom, low_level_linkids, low_level_linkdirs,
			array_to_string(low_level_linkids, ',') as feature_string, 
			md5(array_to_string(low_level_linkids, ',')) as feature_key
	from
	(
		select a.link_id, region_tile_id, a.start_node_id, a.end_node_id, 
		       road_type, pdm_flag, 
		       ...
		       road_name, toll, regulation_flag, a.fazm_path, a.tazm_path, 
		       ...
		       f.pos_cond_speed, f.neg_cond_speed, 
		       the_geom, ARRAY[a.link_id] as low_level_linkids, ARRAY[True] as low_level_linkdirs
		...
		select a.link_id, region_tile_id, b.start_node_id, b.end_node_id, 
		       road_type, pdm_flag, 
		       ...
		       road_name, toll, regulation_flag, b.fazm_path, b.tazm_path, 
		       b.struct_code, b.shortcut_code, b.etc_lane_flag, 
		       b.disobey_flag, b.ops_lane_number, b.ops_width, b.neg_lane_number, b.neg_width, 
		       b.pos_cond_speed, b.neg_cond_speed, 
		       b.the_geom, b.link_array as low_level_linkids, b.linkdir_array as low_level_linkdirs
		from temp_region_links as a
		left join temp_region_merge_joinlink as b
		on a.link_id = b.proxy_link_id
		left join rdb_link_add_info as c
...
as
(
	select	b.link_id, a.region_tile_id, 
			...
			road_type, pdm_flag, path_extra_info, one_way, function_code, link_length, link_type, road_name, toll, 
       		regulation_flag, fazm_path, tazm_path, struct_code, shortcut_code, etc_lane_flag, disobey_flag, 
		...
		(
			...
			(
				...
				(
					...
					from
					(
						select 	record_no, regulation_id, regulation_type, link_num, 
								first_link_id, first_link_id_t, last_link_id, last_link_dir, last_link_id_t, 
			...
			order by record_no, regulation_id, regulation_type, first_link_id, first_link_id_t, 
					 last_link_id, last_link_dir, last_link_id_t, link_num, link_index
		)as b
		group by record_no, regulation_id, regulation_type, first_link_id, first_link_id_t, 
...
(
	SELECT    a.link_id
			...
			as common_main_link_attri
	from link_tbl as a
	left join rdb_tile_link as b
	on a.link_id = b.old_link_id
	where b.tile_link_id is null
	order by a.tile_id, common_main_link_attri
);
...
(
	...
	select b.ecc, b.ccd as cc, b.cname as country
		...
		,n1.name as road_name, n2.name as first_name, n3.name as second_name
		,c.roadnumber as road_number
	...
	left join gewi_names n1
	on a.cid = n1.cid and a.rnid = n1.nid
	left join gewi_names n2
	on a.cid = n2.cid and a.n1id = n2.nid
	left join gewi_names n3
	...
	select b.ecc, b.ccd as cc, b.cname as country
		,a.tabcd::integer as table_no, a.lcd::integer as location_code
		,a.class::character varying as location_type, a.tcd::smallint as type, a.stcd::smallint as subtype
		,n.name as road_name, null::character varying as first_name, null::character varying as second_name
		,null::character varying as road_number
