...
(
  ...
  building_name character varying(512)
);
...
(
  ...
  order2_id integer,
  order8_id integer,
  ad_name character varying(65536)	--澶氳瑷�
);
...
(
  ...
  park_region_title integer,
  park_region_name character varying(1024),
  park_type smallint,
  park_toll smallint,
  park_map_ID bigint
);SELECT AddGeometryColumn('','rdb_park_region','the_geom','4326','POLYGON',2);
...
(
  ...
  park_region_id integer
);SELECT AddGeometryColumn('','rdb_park_node','the_geom','4326','POINT',2);
...
(
  ...
  park_region_id integer
);SELECT AddGeometryColumn('','rdb_park_link','the_geom','4326','LINESTRING',2);
...
------------------------------------------------------------------------
CREATE TABLE rdb_highway_fee_same_toll
(
  gid              SERIAL NOT NULL primary key,
