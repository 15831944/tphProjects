...
class rdb_hwy_path_point(ItemBase):
    ...
    def Do(self):
        ...
        INSERT INTO rdb_highway_path_point(
                    ...
                    unopen_flag, link_id, lonlat,
                    tile_id, "index", node_id,
                    the_geom, link_geom)
            VALUES (%s, %s, %s,
                    %s, %s, %s,
                    %s, %s, %s,
        ...
        for info in self._get_point_info():
            ...
            unopen_flag, link_id, lonlat = info[6:9]
            tile_id, node_id, the_geom = info[9:12]
            link_geom = info[12]
    ...
    def _get_point_info(self):
        ...
        SELECT ic_no, enter_flag, exit_flag,
               main_flag, center_flag, new_flag,
               unopen_flag, tile_link_id, rdb_geom_2_lonlat(n.the_geom) lonlat,
