    ...
    def Do(self):
        ...
        sqlcmd = """
            INSERT INTO rdb_link_with_all_attri_view (
                   ...
                   link_type, extend_flag, fazm_path, tazm_path,
                   shield_flag, regulation_exist_state, link_length_modify,
                   link_length_unit, geom_blob, pdm_flag,
                   common_main_link_attri, pass_side, admin_wide_regulation,
                   region_cost, reserve, width, the_geom)
            (
            SELECT a.gid, a.link_id, a.link_id_t, a.display_class,
                   ...
                   a.link_type, a.extend_flag, a.fazm_path,
                   a.tazm_path, a.shield_flag,
