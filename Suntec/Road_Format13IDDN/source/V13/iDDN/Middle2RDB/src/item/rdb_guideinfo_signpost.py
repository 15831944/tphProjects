...
class rdb_guideinfo_signpost(ItemBase):
        ...
        sqlcmd = """
                  ...
                  SELECT i.tile_link_id as inlinkid
                      ...
                      , (case
                         ...
                         else cast(sp.arrowno as smallint) end) as arrow_no
                      , sp_name
                      , sp.passlink_cnt as passlink_count
    ...
    def _DoContraints(self):
        ...
        sqlcmd = """
                ...
                ALTER TABLE rdb_guideinfo_signpost DROP CONSTRAINT if exists rdb_guideinfo_signpost_out_link_id_fkey;
                ALTER TABLE rdb_guideinfo_signpost
