...
----------------------------------------------------------------------
                ...
                select link_id, link_id_t, start_node_id, end_node_id, road_type, pdm_flag,one_way, 
                   function_code, link_length, link_type, road_name, toll, regulation_exist_state, 
                   fazm_path, tazm_path, link_add_info_flag, speed_regulation_flag, 
                   lane_id, link_length_modify, link_length_unit, the_geom, 
        ...
        table_list = [
                      ...
                      ('rdb_link_regulation', 'record_no', 'regulation_type, link_num, first_link_id, last_link_id, last_link_dir, key_string'),
                      ...
                      ('rdb_region_link_regulation_layer4_tbl', 'record_no', 'regulation_type, link_num, first_link_id, last_link_id, last_link_dir, key_string'),
                      ('rdb_region_link_regulation_layer6_tbl', 'record_no', 'regulation_type, link_num, first_link_id, last_link_id, last_link_dir, key_string'),
