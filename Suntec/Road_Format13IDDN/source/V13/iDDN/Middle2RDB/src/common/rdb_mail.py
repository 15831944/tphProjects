...
class rdb_mail(object):
    '''
    rdb发送mail类: 把log信息发送给相关人员
    '''
    def __init__(self):
        '''
        Constructor
        '''
        self.logfile      =  rdb_log.get_logfile()
        self.from_who     = 'hongcz@pset.suntec.net'
        self.data_version =  rdb_database.rdb_pg.instance().Get_Version()
        self.to_list      = ['hongcz@pset.suntec.net',
                             'zhangliang@pset.suntec.net',
                             'liuxinxing@pset.suntec.net',
                             'zhouchao@pset.suntec.net',
                             'sunyifeng@pset.suntec.net'
                             ]
