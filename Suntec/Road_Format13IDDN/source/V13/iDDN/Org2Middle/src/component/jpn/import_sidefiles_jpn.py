...
class comp_import_sidefiles_jpn(base.component_base.comp_base):

    def __init__(self):

        base.component_base.comp_base.__init__(self, 'sidefiles')
...
class CFileAnalyst_connectway: 
    ...
    def _analyseLine(self, file_name):
        ...
        cw_cnt = common.get_int_value(file_obj, 4)
        
        self.__cur_gid = 0
        for i in range(0, cw_cnt):
            cw_class_node_num = common.get_int_value(file_obj, 4)
            ...
            for j in range(0, node_num):
                mesh = common.get_int_value(file_obj, 4)              
                nodeid = common.get_int_value(file_obj, 4)
