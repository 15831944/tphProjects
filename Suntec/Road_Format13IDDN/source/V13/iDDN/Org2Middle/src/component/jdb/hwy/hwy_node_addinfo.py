...
class HwyNodeAddInfo(base.component_base.comp_base):
    '''
    Node附加情报
    '''
    ...
    def __init__(self):
        ...
        Constructor
        '''
        base.component_base.comp_base.__init__(self, 'HwyNodeAddInfo')
    ...
    def _make_toll_node_add_info(self):
        ...
        for toll in toll_data:
            ...
            addinfo_list = []
            if dummy_toll_node:  # 有dummy收费站，这时收费站信息做在dummy点
    ...
    def _set_toll_class(self, toll_classes, tollclass_c,
        ...
        '''料金种别'''
        if hwy_toll_type.not_guide == IC_TYPE_TRUE:  # 非案内
            hwy_toll_type.dummy_facil = IC_TYPE_TRUE
        # 高速道路入口
...
class AddInfoData():
    def __init__(self, link_id, node_id,
        ...
        self.no_toll_money = no_toll_money
