...
class import_csv_data(base.component_base.comp_base):
    
    def __init__(self):
        '''
        Constructor
        '''
        base.component_base.comp_base.__init__(self, 'ImportCSV')
    ...
    def __parse_csv_file(self, pre_name, file_full_path):
        ...
        objFile = codecs.open(file_full_path, 'r', 'Shift_JIS')
