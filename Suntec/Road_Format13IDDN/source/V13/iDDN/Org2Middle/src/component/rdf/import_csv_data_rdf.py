...
class import_junctionview_data_rdf(base.component_base.comp_base):
    def __init__(self):
        '''
        Constructor
        '''
        base.component_base.comp_base.__init__(self, 'ImportJCV')
...
class CFileAnalyst:
    ...
    def _analyseLine(self, line, flag):
        ...
        if flag == 'all_jv':
            if 'USA' in self.countrys or 'CAN' in self.countrys or 'MEX' in self.countrys:
                # ejv_filename
