...
from component.multi_lang_name import MultiLangShield
...
from component.ta.guideinfo_signpost_uc_ta import SIGN_POST_TYPE_EXIT_NO
from component.ta.guideinfo_signpost_uc_ta import SIGN_POST_TYPE_SHIELD_ID
from component.ta.guideinfo_signpost_uc_ta import SIGN_POST_TYPE_NAME


class comp_guideinfo_signpost_uc_mmi(comp_guideinfo_signpost_uc_ta):
    '''TomTom方面
    '''
...
# ## SignPostElement
#######################################################################
class SignPostElementMmi(SignPostElement):
