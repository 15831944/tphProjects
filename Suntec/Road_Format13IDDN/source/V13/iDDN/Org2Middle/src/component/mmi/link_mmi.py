...
class comp_link_mmi(base.component_base.comp_base):
    '''
    classdocs
    '''
    def __init__(self):
        ...
        sqlcmd = """
                ...
                select 
                 ...
                 select  
                        ...
                        mmi_oneway(oneway, const_st, f.linkdir, p.linkdir_array)   as one_way_code,
                        CASE when tollrd in ('B','FT') or toll_rd = 1 then 1 else 0 end as toll, 
                        ...
                        CASE when a.div_typ in (1, 2) then 1 else 0 END  as disobey_flag, 
