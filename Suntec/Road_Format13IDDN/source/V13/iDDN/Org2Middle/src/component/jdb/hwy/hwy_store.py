...
class HwyStore(base.component_base.comp_base):
    ...
    def __init__(self):
        ...
        Constructor
        '''
        base.component_base.comp_base.__init__(self, 'Highway_Store')
    ...
    def _Do(self):
        ...
        for info in data:
            ...
            for store_info in \
                ...
                ic_store_info = (ic_no, time_flag, time_num, store_code) +\
                                time_info + (seq_nm, )
