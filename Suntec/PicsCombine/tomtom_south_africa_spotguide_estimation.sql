...
select distinct d.inlinkid, d.lat_lon, d.outlinkid, length(e.validity)-1 as outlink_lane_count
...
--******************************************************************************************************************************
select * from temp_target_table where array_upper(outlink_lanecount_list, 1) <> array_upper(array(select distinct unnest(outlink_list)), 1);
--******************************************************************************************************************************
